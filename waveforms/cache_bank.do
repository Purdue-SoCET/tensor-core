...
add wave -noupdate /cache_bank_tb/PROG/tb_mem_instr
...
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/flush_count
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/flush_way
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/flush_set
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/next_flush_count
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/next_flush_way
add wave -noupdate -group {Cache Controller Logic} /cache_bank_tb/dut/next_flush_set
...
add wave -noupdate -group {FSM State Logic} /cache_bank_tb/dut/next_count_FSM
add wave -noupdate -group {FSM State Logic} /cache_bank_tb/dut/count_flush
add wave -noupdate -group {FSM State Logic} /cache_bank_tb/dut/mshr_hit
add wave -noupdate -group {FSM State Logic} /cache_bank_tb/dut/next_mshr_hit
add wave -noupdate -group {FSM State Logic} -childformat {{/cache_bank_tb/dut/mshr_entry.write_status -radix binary}} -expand -subitemconfig {/cache_bank_tb/dut/mshr_entry.write_status {-height 16 -radix binary}} /cache_bank_tb/dut/mshr_entry
add wave -noupdate -expand -group {LRU Logic} /cache_bank_tb/dut/lru
add wave -noupdate -expand -group {LRU Logic} -childformat {{{/cache_bank_tb/dut/next_lru[3]} -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}}} {{/cache_bank_tb/dut/next_lru[2]} -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}}} {{/cache_bank_tb/dut/next_lru[1]} -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}}} {{/cache_bank_tb/dut/next_lru[0]} -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}}}} -subitemconfig {{/cache_bank_tb/dut/next_lru[3]} {-height 16 -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}} -expand} {/cache_bank_tb/dut/next_lru[3].lru_way} {-radix unsigned} {/cache_bank_tb/dut/next_lru[3].age} {-radix decimal} {/cache_bank_tb/dut/next_lru[2]} {-height 16 -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}} -expand} {/cache_bank_tb/dut/next_lru[2].lru_way} {-radix unsigned} {/cache_bank_tb/dut/next_lru[2].age} {-radix decimal} {/cache_bank_tb/dut/next_lru[1]} {-height 16 -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}} -expand} {/cache_bank_tb/dut/next_lru[1].lru_way} {-radix unsigned} {/cache_bank_tb/dut/next_lru[1].age} {-radix decimal} {/cache_bank_tb/dut/next_lru[0]} {-height 16 -radix decimal -childformat {{lru_way -radix unsigned} {age -radix decimal}} -expand} {/cache_bank_tb/dut/next_lru[0].lru_way} {-radix unsigned} {/cache_bank_tb/dut/next_lru[0].age} {-radix decimal}} /cache_bank_tb/dut/next_lru
...
add wave -noupdate -group {Tree LRU Logic} /cache_bank_tb/dut/tree_lru
add wave -noupdate -group {Tree LRU Logic} /cache_bank_tb/dut/next_tree_lru
add wave -noupdate -group {Tree LRU Logic} /cache_bank_tb/dut/way
add wave -noupdate -group {Tree LRU Logic} /cache_bank_tb/dut/hit_bit
add wave -noupdate -group {Tree LRU Logic} /cache_bank_tb/dut/node
...
WaveRestoreCursors {{Cursor 1} {184162 ps} 0}
...
update
WaveRestoreZoom {0 ps} {193468 ps}
