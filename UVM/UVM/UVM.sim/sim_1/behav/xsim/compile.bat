...
REM
REM Generated by Vivado on Sat Jul 19 16:51:13 -0400 2025
...
echo "xvlog --incr --relax -L uvm -L uvm -prj tb_systolic_vlog.prj"
call xvlog  --incr --relax -L uvm -L uvm -prj tb_systolic_vlog.prj -log xvlog.log
