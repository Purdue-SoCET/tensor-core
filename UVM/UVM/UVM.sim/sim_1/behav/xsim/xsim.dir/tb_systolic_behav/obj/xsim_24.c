...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x51e258)) ;
...
extern "C" {
	...
	extern void subprog_m_e55bff6a_556ead11_2282(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 410904, 176, 1120896) ;
		char driver0[32] ;
		...
		DPIScheduleTransactionBlocking(IP +410400, driver0, (char*)(&copyArg_0_0), 0, 31) ;
		const char* copyArg_1_1[1] ;
		copyArg_1_1[0] = ( arg1) ;
		DPIScheduleTransactionBlocking(IP +410456, driver1, (char*)(&copyArg_1_1), 0, 31) ;
		const char* copyArg_2_2[1] ;
		copyArg_2_2[0] = ( arg2) ;
		DPIScheduleTransactionBlocking(IP +410512, driver2, (char*)(&copyArg_2_2), 0, 31) ;
		char copyArg_3_3[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +410568, driver3, (char*)(&copyArg_3_3), 0, 31) ;
		const char* copyArg_4_4[1] ;
		copyArg_4_4[0] = ( arg4) ;
		DPIScheduleTransactionBlocking(IP +410624, driver4, (char*)(&copyArg_4_4), 0, 31) ;
		char copyArg_5_5[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +410680, driver5, (char*)(&copyArg_5_5), 0, 31) ;
		char* oldSP = *((char**)(IP + callingProcessOffset + 80)) ; 
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_e55bff6a_556ead11_2282), IP) ;
