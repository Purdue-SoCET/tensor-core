...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x51b0e0)) ;
...
extern "C" {
	...
	extern void subprog_m_e55bff6a_556ead11_2273(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 410904, 176, 811864) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_e55bff6a_556ead11_2273), IP) ;
