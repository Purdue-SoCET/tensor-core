// TODO: 
// 1. Top Level Remains the same 
// 2. Bank removes tagging logic 
// 3. cache_bank itself will remove the 'tag'
//     How does replacement happen? 
//     addresses are generated by a different logic block -> not DRAM based, can we increase the addressable size? 
