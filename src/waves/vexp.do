...
add wave -noupdate -expand -group {VExp Internal Signals} -color Yellow -radix binary /vexp_tb/dut/fp1
...
add wave -noupdate -expand -group {VExp Signals} -color Cyan /vexp_tb/vexpif/port_a
add wave -noupdate -expand -group {VExp Signals} -color Cyan /vexp_tb/vexpif/out
add wave -noupdate -expand -group {VExp Signals} -color Cyan /vexp_tb/vexpif/enable
add wave -noupdate -expand -group TB -color Magenta /vexp_tb/burst_vec
add wave -noupdate -expand -group TB -color Magenta /vexp_tb/cycle
...
update
WaveRestoreZoom {99981723 ps} {99986174 ps}
