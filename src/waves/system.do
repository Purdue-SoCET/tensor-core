...
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_busy
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/FS/fust
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/en
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/fu
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/fust_row
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/t1
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/t2
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/flush
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/resolved
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/busy
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_busy
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_t1
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_t2
add wave -noupdate -expand -group dispatch -expand -group fusif /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_op
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_op
add wave -noupdate -expand -group dispatch -expand /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_t1
add wave -noupdate -expand -group dispatch -expand /system_tb/DUT/DP/SCOREBOARD/IS/fusif/out_t2
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/fust_s_out_busy
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/fust_s_out_op
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/fust_s_out_t1
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/fust_s_out_t2
...
WaveRestoreCursors {{Cursor 7} {6764095 ps} 1} {{Cursor 2} {104053 ps} 1} {{Cursor 3} {58536 ps} 0}
...
update
WaveRestoreZoom {0 ps} {201418 ps}
